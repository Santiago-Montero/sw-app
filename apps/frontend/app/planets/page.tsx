    ...
    <div className="container mx-auto py-12 px-4">
      <div className="flex flex-col items-center justify-center mb-12">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h1 className="text-4xl font-bold text-center">Planetas de Star Wars</h1>
          <Star className="h-8 w-8 text-yellow-400" />
        </div>
...
async function PlanetsList({ page, search }: { page: number; search: string }) {
  try {
    ...
    return (
      <div className="flex flex-col items-center justify-center py-16">
        <h3 className="text-2xl font-medium text-red-600 mb-2">Error al cargar los planetas</h3>
